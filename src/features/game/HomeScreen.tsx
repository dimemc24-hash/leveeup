    ...
    <div className="p-4 max-w-lg mx-auto space-y-4 animate-slide-up">
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <Link
            to="/minigames/builder"
            className="rounded-xl p-3 text-center transition-all hover:scale-105 active:scale-95"
            style={{ background: 'rgba(255,255,255,0.06)', border: '1.5px solid rgba(255,184,0,0.2)' }}
          >
            <div className="text-2xl mb-1">🧱</div>
            <div className="text-xs font-bold text-bark-light">Swamp Builder</div>
          </Link>
          <Link
            to="/minigames/sorting"
            className="rounded-xl p-3 text-center transition-all hover:scale-105 active:scale-95"
            style={{ background: 'rgba(255,255,255,0.06)', border: '1.5px solid rgba(0,200,150,0.2)' }}
          >
            <div className="text-2xl mb-1">🦎</div>
            <div className="text-xs font-bold text-bark-light">Creature Feature</div>
          </Link>
        </div>
      </div>
